...
class Trainer(object):
    ...
    def train(self, device, train_iter_fct, train_steps, valid_iter_fct=None, valid_steps=-1):
        """
    ...
    def _save(self, epoch):
        ...
        checkpoint_path = os.path.join(self.args.model_path, "model_epoch_%d.pt" % epoch)
