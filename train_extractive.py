...
def train_ext(args, device_id):
    if (args.world_size > 1):
        ...
        train_single_ext(args, args.device_id)
...
def train_single_ext(args, device_id):
    ...
    def train_iter_fct():
        return data_loader.Dataloader(args, load_dataset(args, corpus_type='train', shuffle=True), args.batch_size, device,
    ...
    trainer.train(device, train_iter_fct, args.train_steps)
